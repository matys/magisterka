 ...
 * Time: 11:12
 */
public class CollisionAvoidingWithDecisionPrioritizationProblemController implements Runnable {
    private CollisionAvoidingWithSafetyModeProblem problem = null;
    private ControlLearner control;
    private Clock clock = new Clock("CollisionAvoidingWithDecisionPrioritizationProblemController");
    ...
    public CollisionAvoidingWithDecisionPrioritizationProblemController(
    ...
    public void init() {
        problem = new CollisionAvoidingWithSafetyModeProblem(intersectionConfiguration.getAgentRange(),
                intersectionConfiguration.getMaxSpeedChange());
        problem.setCurrentState(new CollisionAvoidingWithSafetyModeState());
        problem.initialize();
...
//            printTheta();
    ...
    public void setCurrentState(CollisionAvoidingWithSafetyModeState collisionAvoidingState) {
