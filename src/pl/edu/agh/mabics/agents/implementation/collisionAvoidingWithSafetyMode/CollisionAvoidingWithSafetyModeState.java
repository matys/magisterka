 ...
 * Time: 16:10
 */
public class CollisionAvoidingWithSafetyModeState {
    ...
    public CollisionAvoidingWithSafetyModeState(PlatformRequest request, int reward) {
    ...
    public CollisionAvoidingWithSafetyModeState() {
