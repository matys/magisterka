...
import pl.edu.agh.mabics.agents.implementation.collisionAvoidingWithSupervisionByClassifier.CollisionAvoidingWithSupervisionByClassifierProblemController;
import pl.edu.agh.mabics.agents.implementation.collisionAvoidingWithSupervisionByClassifier.CollisionAvoidingWithSupervisionByClassifierState;
...
@Service
public class AvoidingCollisionsWithSupervisionByClassifierAgent extends AbstractAgent {

    private CollisionAvoidingWithSupervisionByClassifierProblemController problemController;
...
//                    System.out.println("waiting for action to be chosen by controller (first time)");
        ...
        problemController.setCurrentState(
                new CollisionAvoidingWithSupervisionByClassifierState(request, problemController.getReward()));
...
//                System.out.println("waiting for action to be chosen by controller");
    ...
    public void initIt() {
        problemController = new CollisionAvoidingWithSupervisionByClassifierProblemController(
                intersectionConfiguration);
        initParameters(problemController, CollisionAvoidingWithSupervisionByClassifierProblemController.class);
