 ...
 * Time: 16:10
 */
public class CollisionAvoidingWithSupervisionByClassifierState {
    ...
    private int reward;
    public static final Integer NUMBER_OF_STATE_ATTRIBUTES_TO_REDUCE = 4;

    public CollisionAvoidingWithSupervisionByClassifierState(PlatformRequest request, int reward) {
    ...
    public CollisionAvoidingWithSupervisionByClassifierState() {
    ...
    public String toString() {
        return "(" + this.distanceToTarget + " (" + this.agentDistanceToCollisionPoint + "," +
                "" + this.collisionAgentDistanceToCollisionPoint + "," + this.agentSpeed + "," +
                "" + this.collisionAgentSpeed +
                "))" + "" +
                " reward: " + this.reward;
    }
