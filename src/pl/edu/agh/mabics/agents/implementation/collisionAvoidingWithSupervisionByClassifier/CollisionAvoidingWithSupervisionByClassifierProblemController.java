 ...
 * Time: 11:12
 */
public class CollisionAvoidingWithSupervisionByClassifierProblemController implements Runnable {
    private CollisionAvoidingWithSupervisionByClassifierProblem problem = null;
    private ControlLearner control;
    private Clock clock = new Clock("CollisionAvoidingWithSupervisionByClassifierProblemController");
    ...
    public CollisionAvoidingWithSupervisionByClassifierProblemController(
    ...
    public void init() {
        problem = new CollisionAvoidingWithSupervisionByClassifierProblem(intersectionConfiguration.getAgentRange(),
                intersectionConfiguration.getMaxSpeedChange());
        problem.setCurrentState(new CollisionAvoidingWithSupervisionByClassifierState());
        problem.initialize();
