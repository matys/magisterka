 ...
 * Time: 11:12
 */
public class CollisionAvoidingWithClassificationProblemController implements Runnable {
    private CollisionAvoidingWithClassificationProblem problem = null;
    private ControlLearner control;
    private Clock clock = new Clock("CollisionAvoidingWithClassificationProblemController");
    ...
    public CollisionAvoidingWithClassificationProblemController(IntersectionConfiguration intersectionConfiguration) {
        this.intersectionConfiguration = intersectionConfiguration;
    }


    public void init() {
        problem = new CollisionAvoidingWithClassificationProblem(intersectionConfiguration.getAgentRange(),
                intersectionConfiguration.getMaxSpeedChange());
        problem.setCurrentState(new CollisionAvoidingWithClassificationState());
        problem.initialize();
