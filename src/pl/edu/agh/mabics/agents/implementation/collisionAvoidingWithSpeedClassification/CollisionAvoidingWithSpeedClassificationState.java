 ...
 * Time: 16:10
 */
public class CollisionAvoidingWithSpeedClassificationState {
    ...
    public CollisionAvoidingWithSpeedClassificationState(PlatformRequest request, int reward) {
    ...
    public CollisionAvoidingWithSpeedClassificationState() {
