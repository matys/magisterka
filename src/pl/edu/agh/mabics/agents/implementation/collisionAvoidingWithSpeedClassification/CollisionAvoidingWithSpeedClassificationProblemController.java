 ...
 * Time: 11:12
 */
public class CollisionAvoidingWithSpeedClassificationProblemController implements Runnable {
    private CollisionAvoidingWithSpeedClassificationProblem problem = null;
    private ControlLearner control;
    private Clock clock = new Clock("CollisionAvoidingWithSpeedClassificationProblemController");
    ...
    public CollisionAvoidingWithSpeedClassificationProblemController(
    ...
    public void init() {
        problem = new CollisionAvoidingWithSpeedClassificationProblem(intersectionConfiguration.getAgentRange(),
                intersectionConfiguration.getMaxSpeedChange());
        problem.setCurrentState(new CollisionAvoidingWithSpeedClassificationState());
        problem.initialize();
